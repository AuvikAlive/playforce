  ...
  var _ref = _asyncToGenerator(function* (requestBody) {
    ...
    const docDefinition = {
      ...
      content: [yield (0, _makeCover.makeCover)({
        ...
        client,
        author
      }), yield (0, _makeAuditSummary.makeAuditSummary)(inspection.auditSummary, author, site), (0, _makeConditionRatingInfo.makeConditionRatingInfo)(), (0, _makeConditionRatings.makeConditionRatings)(equipment), (0, _makeImpactTests.makeImpactTests)(impactTest, inspection.standards)]
    };
