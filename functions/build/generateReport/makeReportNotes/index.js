...
const makeReportNotes = ({
  appliedStandards
}, reportNotes) => [(0, _makeTitle.makeTitle)(), (0, _makeSubtitle.makeSubtitle)(), reportNotes && reportNotes.length > 0 ? (0, _makeCustomNotes.makeCustomNotes)(reportNotes) : (0, _makeDefaultNotes.makeDefaultNotes)(appliedStandards), (0, _makeOutro.makeOutro)()];
