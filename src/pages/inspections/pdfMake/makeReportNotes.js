  ...
  },
  {
    ...
    columns: [
      ...
      [
        ...
        {
          text: `The equipment in this report has been assessed, were applicable, in accordance with ${appliedStandards.join(
            ' ',
          )}`,
          marginBottom: verticalMargin,
        },
  ...
  },
  {
    ...
    columns: [
      ...
      [
        {
          width: '*',
          text: `${appliedStandards.join(' ')} Inspection Frequencies`,
          bold: true,
          marginBottom: verticalMargin / 2,
        },
        {
